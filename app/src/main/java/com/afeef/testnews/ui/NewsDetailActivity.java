...
public class NewsDetailActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener{
    ...
    private ImageView imageView, iv_save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time.setText(mSource + author);

        if (savedDao.isFavourite(id)){
        ...
        iv_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (savedDao.isFavourite(id)){
                    iv_save.setImageResource(R.drawable.ic_save);
                    Toast.makeText(NewsDetailActivity.this,"Unsave",Toast.LENGTH_SHORT).show();
                    savedDao.removeSaved(id);
                }else{
                    iv_save.setImageResource(R.drawable.ic_saved_item);
                    Toast.makeText(NewsDetailActivity.this,"save",Toast.LENGTH_SHORT).show();

                    SavedArticle savedArticle = new SavedArticle(id);
